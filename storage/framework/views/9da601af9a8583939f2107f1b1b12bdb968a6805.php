                ...
                <div class="layar-dalam">
                    ...
                    <div class ="tempat">
                        <div class ="kelompokutama">
                            <div class="tempatutama"><img src="../storage/<?php echo e($tempat->img); ?>"></div>
                        </div>
                    <div class="isi">
                        <section id="keterangan">
                            ...
                            <div class="kanan">
                                ...
                                <div class="Harga">
                                    <?php if($tempat->harga >= 1000000): ?>
                                    <h1>Rp.<?php echo e($tempat->harga/1000000); ?>.<?php echo e("000.000"); ?>,-</h1>
                                    
                                    <?php elseif($tempat->harga >= 1000 and $tempat->harga <1000000): ?>
                                    <h1>Rp.<?php echo e($tempat->harga/1000); ?>.<?php echo e("000"); ?>,-</h1>
                                    <?php endif; ?>
                                </div>
                        ...
                        <section id="Map">
                            ...
                            <div class ="kelompok1">
                                ...
                                <div class="tempat1" onclick="window.location.href='<?php echo e($r->id); ?>'"><img src="../storage/<?php echo e($r->img); ?>">
